...
def test_process_param_type_data_object():
    ...
    param = dummy_param({"field_type": "text", "text_options": {"valid_ws_types": ws_types}})
...
def test_process_param_type_dropdown():
    ...
    param = dummy_param({"field_type": "dropdown", "dropdown_options": {"options": dropdown_opts}})
...
def test_generate_input():
    ...
    suffix = "suf"
    num_symbols = 8
    generator = AutoGeneratedValue(**{"symbols": num_symbols, "prefix": prefix, "suffix": suffix})
