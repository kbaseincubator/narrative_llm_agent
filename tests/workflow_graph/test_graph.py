...
def mock_workflow_nodes():
    with patch('narrative_llm_agent.workflow_graph.graph.WorkflowNodes') as mock_nodes:
        ...
        mock_nodes.return_value.workflow_runner_node = Mock()
...
def test_build_graph(mock_workflow_nodes, mock_state_graph):
    ...
    mock_graph_instance.add_node.assert_any_call("run_workflow_step", mock_workflow_nodes.return_value.workflow_runner_node)
...
def test_workflow_end_to_end():
    ...
    with patch('narrative_llm_agent.workflow_graph.graph.WorkflowNodes') as mock_nodes:
        ...
        mock_nodes.return_value.workflow_runner_node = mock_runner
